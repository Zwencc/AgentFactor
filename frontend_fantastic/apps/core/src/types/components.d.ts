...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    DirectoryPickerModal: typeof import('./../components/DirectoryPickerModal/index.vue')['default']
...
declare global {
  ...
  const DirectoryPickerModal: typeof import('./../components/DirectoryPickerModal/index.vue')['default']
